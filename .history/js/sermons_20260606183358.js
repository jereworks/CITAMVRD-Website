...
/*
====================================================
CITAM Valley Road — Sermons Archive (No YouTube API)
Auto-loads videos from Channel Uploads Playlist
...
/*
=========================================
CITAM Sermons — YouTube Channel Embed
No API • Auto Updates • Unlimited Videos
=========================================
*/

document.addEventListener("DOMContentLoaded", () => {

    const grid = document.getElementById("dynamic-sermon-grid");
    ...
    <section class="youtube-archive">
        ...
        <div class="archive-header">
            ...
            <p class="max-width-text">
                Browse all sermons directly from our YouTube channel.
                Newly uploaded messages appear automatically.
            </p>
        </div>
        ...
        <div class="youtube-wrapper">
            ...
            <iframe
                src="https://www.youtube.com/embed?listType=user_uploads&list=CITAMChurchOnline"
        ...
        <div class="sermon-more-container">

            <a
                class="btn btn-primary"
                target="_blank"
                href="https://www.youtube.com/@citamvalleyroad">
