...
class SermonApp {
    ...
    async loadData() {
        ...
        if (cached) {
            try {
                ...
                // If cache is corrupted, just ignore it and load fresh
    ...
    renderGrid() {
        ...
        // Calculate offset - if featured is showing, we skip index 0 on page 1
        ...
        if (isFeaturedShowing && this.state.currentPage === 1) {
            videosToRender.shift(); // Remove the featured video from grid
        }
