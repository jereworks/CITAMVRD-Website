...
class SermonApp {
            ...
            skeletonHTML += `
                <article class="skeleton-card">
                    ...
                    <div class="skeleton-body">
                        ...
                        <div class="skeleton-line meta skeleton-box" style="margin-top: 15px;"></div>
                    </div>
                </article>
            `;
        }
    ...
    showError() {
        this.elements.grid.innerHTML = '<div style="padding:80px;text-align:center;color:red;">Unable to load sermons.</div>';
    }
