...
class SermonApp {
    constructor() {
        this.grid = document.getElementById('dynamic-sermon-grid');
        this.featured = document.getElementById('featured-sermon-container');

        this.init();
    }

    init() {
        this.renderChannelArchive();
    }

    renderChannelArchive() {

        const uploadsPlaylist =
            'UU' + CONFIG.CHANNEL_ID.substring(2);
